...
export function appendDataset(graph, dataset) {
    const current = graph ?? { title: 'Untitled Graph', datasets: [], globalConfig: { showGrid: true, enableZoom: true, xAxisLabel: 'X', yAxisLabel: 'Y', aspectRatio: 'square', showLabels: false }, annotations: [], createdAt: new Date().toISOString() };
